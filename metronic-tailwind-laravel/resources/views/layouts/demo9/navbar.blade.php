	...
	<div class="kt-container-fixed lg:flex lg:flex-wrap lg:justify-between lg:items-center gap-2 px-0 lg:px-7.5">
		...
		<div class="kt-menu items-stretch flex-col lg:flex-row gap-5 lg:gap-7.5 grow lg:grow-0" data-kt-menu="true" id="mega_menu">
			<div class="kt-menu-item active">
				<a class="kt-menu-link lg:py-3.5 border-b border-b-transparent kt-menu-item-active:border-b-mono text-foreground kt-menu-item-hover:text-mono kt-menu-item-active:text-mono kt-menu-item-here:border-b-mono kt-menu-item-here:text-mono" href="html/demo9.html">
							...
							<div class="kt-menu kt-menu-default kt-menu-fit flex-col">
								...
								<div class="grid lg:grid-cols-2 lg:gap-5">
									...
									<div>
										...
										<div class="kt-menu-item">
											<a class="kt-menu-link" href="html/demo9/public-profile/empty.html" tabindex="0">
												<span class="kt-menu-icon">
			...
			<div class="kt-menu-item" data-kt-menu-item-offset="-158px, 0" data-kt-menu-item-offset-rtl="158px, 0" data-kt-menu-item-overflow="true" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="accordion|lg:dropdown" data-kt-menu-item-trigger="click|lg:hover">
				<div class="kt-menu-link lg:py-3.5 border-b border-b-transparent kt-menu-item-active:border-b-mono text-foreground kt-menu-item-hover:text-mono kt-menu-item-active:text-mono kt-menu-item-here:border-b-mono kt-menu-item-here:text-mono">
					<span class="kt-menu-title font-medium text-foreground text-sm">
						Account
					</span>
						...
						<div class="grid lg:grid-cols-5 gap-5">
							...
							<div class="flex flex-col">
								...
								<div class="kt-menu kt-menu-default kt-menu-fit flex-col">
									...
									<div class="kt-menu-item">
										<a class="kt-menu-link" href="html/demo9/account/appearance.html" tabindex="0">
											<span class="kt-menu-title grow-0">
												Appearance
											</span>
										</a>
			...
			<div class="kt-menu-item" data-kt-menu-item-offset="-50px, 0" data-kt-menu-item-offset-rtl="50px, 0" data-kt-menu-item-overflow="true" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="accordion|lg:dropdown" data-kt-menu-item-trigger="click|lg:hover">
				<div class="kt-menu-link lg:py-3.5 border-b border-b-transparent kt-menu-item-active:border-b-mono text-foreground kt-menu-item-hover:text-mono kt-menu-item-active:text-mono kt-menu-item-here:border-b-mono kt-menu-item-here:text-mono">
					<span class="kt-menu-title font-medium text-foreground text-sm">
						Network
					</span>
			...
			<div class="kt-menu-item" data-kt-menu-item-offset="-100px, 0" data-kt-menu-item-offset-rtl="100px, 0" data-kt-menu-item-overflow="true" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-placement-rtl="bottom-end" data-kt-menu-item-toggle="accordion|lg:dropdown" data-kt-menu-item-trigger="click|lg:hover">
				<div class="kt-menu-link lg:py-3.5 border-b border-b-transparent kt-menu-item-active:border-b-mono text-foreground kt-menu-item-hover:text-mono kt-menu-item-active:text-mono kt-menu-item-here:border-b-mono kt-menu-item-here:text-mono">
					<span class="kt-menu-title font-medium text-foreground text-sm">
						Auth
					</span>
					...
					<div class="flex flex-col lg:flex-row">
						...
						<div class="lg:w-[260px] mb-4 lg:mb-0 lg:border-s lg:border-s-border rounded-xl lg:rounded-e-xl lg:rounded-l-none shrink-0 px-3 py-4 lg:p-7.5 bg-muted/25">
							...
							<div class="kt-menu kt-menu-default kt-menu-fit flex-col">
								...
								<div class="kt-menu-item">
									<a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="html/demo9/authentication/error-404.html">
										<span class="kt-menu-icon">
								...
								<div class="kt-menu-item">
									<a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border" href="html/demo9/authentication/error-500.html">
										<span class="kt-menu-icon">
