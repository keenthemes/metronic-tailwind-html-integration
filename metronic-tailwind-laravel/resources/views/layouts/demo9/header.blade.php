    ...
    <div class="kt-container-fixed flex lg:justify-between items-center gap-2.5">
        ...
        <div class="flex items-center gap-1 lg:w-[400px] grow lg:grow-0">
            ...
            <div class="flex items-center gap-2">
                <a class="flex items-center shrink-0" href="{{ route('demo9.index') }}">
                                    ...
                                    <div class="flex flex-col gap-2.5 grow">
                                        ...
                                        <div class="flex items-center gap-2.5">
                                            <div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
                                                <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24" style="background-image: url('{{ asset('assets/media/images/600x600/6.jpg') }}')">
                                                </div>
                                            ...
                                            <div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
                                                <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24" style="background-image: url('{{ asset('assets/media/images/600x600/1.jpg') }}')">
                                                </div>
                                                <div class="px-2.5 pb-2">
                                                    <a class="font-medium block text-secondary-foreground hover:text-primary text-xs leading-4 mb-0.5" href="#">
                    ...
                    <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
                        <button class="kt-menu-toggle kt-btn kt-btn-mono">
                            ...
                            <span class="lg:hidden">
                                <i class="ki-filled ki-plus text-sm">
                                </i>
                            </span>
                            <span class="hidden lg:inline-flex">
                                <i class="ki-filled ki-down text-sm">
                                </i>
                            </span>
                        </button>
