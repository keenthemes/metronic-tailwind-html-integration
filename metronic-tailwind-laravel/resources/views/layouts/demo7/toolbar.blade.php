<div class="flex items-center justify-between flex-wrap gap-2 la:gap-5 my-5">
	<div class="flex flex-col gap-1">
		...
		<div class="flex items-center gap-1 text-sm">
			<a class="text-secondary-foreground hover:text-primary" href="/metronic/tailwind/demo7/">
				Home
			</a>
	...
	<div class="flex items-center flex-wrap gap-1.5 lg:gap-3.5">
		<a class="kt-btn kt-btn-outline" href="/metronic/tailwind/demo7/account/home/get-started">
			<i class="ki-filled ki-exit-down text-base!">
			</i>
			Export
		</a>
		<div class="kt-menu kt-menu-default" data-kt-menu="true">
			<div class="kt-menu-item kt-menu-item-dropdown" data-kt-menu-item-offset="0, 0" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="hover">
