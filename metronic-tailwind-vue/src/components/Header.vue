		...
		<div
					...
					<div
						...
						<div
							...
							<div
								...
								<div
									...
									<span class="kt-menu-arrow flex lg:hidden">
										<span
											class="kt-menu-item-show:hidden text-muted-foreground">
								...
								<div class="kt-menu-dropdown w-full gap-0 lg:max-w-[900px]">
									...
									<div
										...
										<div class="flex flex-col gap-1.5">
											<div
												class="text-base font-semibold text-mono leading-none">
												Read to Get Started ?
											</div>
											<div
												class="text-sm fomt-medium text-secondary-foreground">
							...
							<div
								...
								<div
									class="kt-menu-dropdown flex-col gap-0 w-full lg:max-w-[670px]">
											...
											<div class="grid lg:grid-cols-2 lg:gap-5">
												<div class="flex flex-col gap-0.5">
													<div class="kt-menu-item">
														<a
															class="kt-menu-link"
															href="html/demo1/store-client/home.html"
															tabindex="0">
															<span class="kt-menu-icon">
													...
													<div class="kt-menu-item">
														<a
															class="kt-menu-link"
															href="html/demo1/store-client/product-details.html"
															tabindex="0">
															<span class="kt-menu-icon">
													...
													<div class="kt-menu-item">
														<a
															class="kt-menu-link"
															href="html/demo1/store-client/shopping-cart.html"
															tabindex="0">
															<span class="kt-menu-icon">
													...
													<div class="kt-menu-item">
														<a
															class="kt-menu-link"
															href="html/demo1/store-client/wishlist.html"
															tabindex="0">
															<span class="kt-menu-icon">
																<i class="ki-filled ki-heart"> </i>
															</span>
												...
												<div>
													...
													<div class="kt-menu-item">
														<a
															class="kt-menu-link"
															href="html/demo1/store-client/my-orders.html"
															tabindex="0">
															<span class="kt-menu-icon">
													...
													<div class="kt-menu-item">
														<a
															class="kt-menu-link"
															href="html/demo1/store-client/order-receipt.html"
															tabindex="0">
															<span class="kt-menu-icon">
																<i class="ki-filled ki-document"> </i>
															</span>
							...
							<div
								...
								<div
									class="kt-menu-dropdown flex-col gap-0 w-full lg:max-w-[700px]">
									<div class="flex flex-col lg:flex-row">
										<div class="pt-4 pb-2 lg:p-7.5 lg:pb-5 grow">
											<div class="grid lg:grid-cols-2 gap-5">
												<div class="flex flex-col">
							...
							<div
								...
								<div
									class="kt-menu-dropdown kt-menu-default py-2.5 w-full max-w-[220px]">
									<div class="kt-menu-item">
										<a
											class="kt-menu-link"
									...
									<div class="kt-menu-item">
										<a
											...
											<span
												class="kt-menu-badge"
												data-kt-tooltip="#menu_tooltip_3">
												<i
			...
			<div class="flex items-center gap-2.5">
							...
							<div
								...
								<div class="flex grow gap-2.5 px-5">
									<div class="kt-avatar size-8">
										...
										<div class="kt-avatar-indicator -end-2 -bottom-2">
											<div
												class="kt-avatar-status kt-avatar-status-online size-2.5"></div>
										</div>
									</div>
								...
								<div class="flex grow gap-2.5 px-5">
									<div class="kt-avatar size-8">
										...
										<div class="kt-avatar-indicator -end-2 -bottom-2">
											<div
												class="kt-avatar-status kt-avatar-status-offline size-2.5"></div>
										</div>
									</div>
							...
							<div
								...
								<div class="flex items-center flex-wrap gap-2">
									...
									<div class="flex flex-col">
										...
										<span
											class="text-xs font-medium italic text-muted-foreground">
											Jessy is typing..
										</span>
									</div>
								</div>
							...
							<div class="flex items-end justify-end gap-3.5 px-5">
								...
								<div class="relative shrink-0">
									<div class="kt-avatar size-9">
										<div class="kt-avatar-image">
											<img alt="avatar" src="/media/avatars/300-2.png" />
										</div>
										<div class="kt-avatar-indicator -end-2 -bottom-2">
											<div
												class="kt-avatar-status kt-avatar-status-online size-2.5"></div>
							...
							<div class="flex items-center justify-between gap-3 grow">
								<div class="flex flex-col">
									<div class="text-sm mb-px">
										<a
											class="hover:text-primary font-semibold text-mono"
											href="#">
											Jane Perez
										</a>
										<span class="text-secondary-foreground">
				...
				<div
					...
					<div
						class="kt-dropdown-menu p-0 w-screen max-w-[320px]"
