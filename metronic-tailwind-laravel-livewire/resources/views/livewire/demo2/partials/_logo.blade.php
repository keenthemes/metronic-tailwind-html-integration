  ...
  <div class="flex items-center gap-2 lg:gap-5 2xl:-ml-[60px]">
	<a href="{{ url(\'html/demo2.html\') }}">
	 <img class="dark:hidden min-h-[42px]" src="{{ asset(\'assets/media/app/mini-logo-circle.svg\') }}"/>
	 <img class="hidden dark:inline-block min-h-[42px]" src="{{ asset(\'assets/media/app/mini-logo-circle-dark.svg\') }}"/>
	</a>
	  ...
	  <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="hover">
	   ...
	   <div class="kt-menu-dropdown kt-menu-default w-48">
		<div class="kt-menu-item">
		 <a class="kt-menu-link" href="{{ url(\'html/demo2/public-profile/profiles/default.html\') }}" tabindex="0">
		...
		<div class="kt-menu-item">
		 <a class="kt-menu-link" href="{{ url(\'html/demo2/network/get-started.html\') }}" tabindex="0">
		  <span class="kt-menu-icon">
		...
		<div class="kt-menu-item">
		 <a class="kt-menu-link" href="{{ url(\'html/demo2/authentication/get-started.html\') }}" tabindex="0">
		  <span class="kt-menu-icon">
		...
		<div class="kt-menu-item">
		 <a class="kt-menu-link" href="{{ url(\'html/demo2/store-client/home.html\') }}" tabindex="0">
		  <span class="kt-menu-icon">
