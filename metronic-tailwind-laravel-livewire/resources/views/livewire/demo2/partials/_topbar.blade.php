 ...
 <div class="flex items-center gap-2.5">
	<!-- Notifications -->
	<button class="kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full" data-kt-drawer-toggle="#notifications_drawer">
		...
		<div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
		 ...
		 <div class="kt-menu-item" data-kt-menu-item-offset="-15px, 0" data-kt-menu-item-placement="right-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
		  ...
		  <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]">
		   <div class="kt-menu-item">
			<a class="kt-menu-link" href="{{ url(\'html/demo2/account/home/settings-sidebar.html\') }}">
			 <span class="kt-menu-icon">
	...
	<div class="hidden kt-drawer kt-drawer-end card flex-col max-w-[90%] w-[450px] top-5 bottom-5 end-5 rounded-xl border border-border" data-kt-drawer="true" data-kt-drawer-container="body" id="chat_drawer">
		...
		<div class="flex items-center gap-2.5">
		 ...
		 <div class="kt-menu" data-kt-menu="true">
		  <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
		   ...
		   <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
			<div class="kt-menu-item">
			 <a class="kt-menu-link" href="{{ url(\'html/demo2/account/members/teams.html\') }}">
			  <span class="kt-menu-icon">
			...
			<div class="kt-menu-item">
			 <a class="kt-menu-link" href="{{ url(\'html/demo2/account/security/privacy-settings.html\') }}">
			  <span class="kt-menu-icon">
	 ...
	 <div class="mb-2.5">
	  ...
	  <div class="relative grow mx-5">
	   <img alt="" class="rounded-full size-[30px] absolute start-0 top-2/4 -translate-y-2/4 ms-2.5" src="{{ asset(\'assets/media/avatars/300-2.png\') }}">
	...
	<div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-20px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start" data-kt-dropdown-trigger="click">
	 <div class="cursor-pointer shrink-0" data-kt-dropdown-toggle="true">
	  <img alt="" class="size-9 rounded-full border-2 border-input shrink-0" src="{{ asset(\'assets/media/avatars/gray/5.png\') }}">
	  </img>
	 </div>
	 <div class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
	   ...
	   <div class="flex items-center gap-2">
		<img alt="" class="size-9 shrink-0 rounded-full border-2 border-green-500" src="{{ asset(\'assets/media/avatars/300-2.png\') }}">
		 <div class="flex flex-col gap-1.5">
		  ...
		  <a class="text-xs text-secondary-foreground hover:text-primary font-medium leading-none" href="{{ url(\'html/demo2/account/home/get-started.html\') }}">
		   c.fisher@gmail.com
		  </a>
		 </div>
		</img>
	  ...
	  <ul class="kt-dropdown-menu-sub">
	   ...
	   <li>
		<a class="kt-dropdown-menu-link" href="{{ url(\'html/demo2/public-profile/profiles/default.html\') }}">
	   ...
	   <li>
		<a class="kt-dropdown-menu-link" href="{{ url(\'html/demo2/account/home/user-profile.html\') }}">
	   ...
	   <li data-kt-dropdown="true" data-kt-dropdown-placement="right-start" data-kt-dropdown-trigger="hover">
		...
		<div class="kt-dropdown-menu w-[220px]" data-kt-dropdown-menu="true">
		 <ul class="kt-dropdown-menu-sub">
		  <li>
		   <a class="kt-dropdown-menu-link" href="{{ url(\'html/demo2/account/home/get-started.html\') }}">
		  ...
		  <li>
		   <a class="kt-dropdown-menu-link" href="{{ url(\'html/demo2/account/security/overview.html\') }}">
		  ...
		  <li>
		   <a class="kt-dropdown-menu-link" href="{{ url(\'html/demo2/account/members/teams.html\') }}">
		  ...
		  <li>
		   <a class="kt-dropdown-menu-link" href="{{ url(\'html/demo2/account/integrations.html\') }}">
	  ...
	  <div class="px-2.5 pt-1.5 mb-2.5 flex flex-col gap-3.5">
	   ...
	   <a class="kt-btn kt-btn-outline justify-center w-full" href="{{ url(\'html/demo2/authentication/classic/sign-in.html\') }}">
		Log out
	   </a>
	  </div>
	 </div>
