				...
				<div class="flex items-center gap-2.5">
				 ...
				 <div class="kt-menu" data-kt-menu="true">
				  <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
				   ...
				   <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
					<div class="kt-menu-item">
					 <a class="kt-menu-link" href="{{ url(\'html/demo1/account/members/teams.html\') }}">
					  <span class="kt-menu-icon">
					...
					<div class="kt-menu-item" data-kt-menu-item-offset="-15px, 0" data-kt-menu-item-placement="right-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
					 ...
					 <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]">
					  <div class="kt-menu-item">
					   <a class="kt-menu-link" href="{{ url(\'html/demo1/account/members/import-members.html\') }}">
						<span class="kt-menu-icon">
					...
					<div class="kt-menu-item">
					 <a class="kt-menu-link" href="{{ url(\'html/demo1/account/security/privacy-settings.html\') }}">
					  <span class="kt-menu-icon">
			...
			<div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-10px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start">
			 ...
			 <div class="kt-dropdown-menu p-0 w-screen max-w-[320px]" data-kt-dropdown-menu="true">
			  ...
			  <div class="grid p-5 border-t border-t-border">
			   <a class="kt-btn kt-btn-outline justify-center" href="{{ url(\'html/demo1/account/integrations.html\') }}">
				Go to Apps
			   </a>
			  </div>
			 </div>
			...
			<div class="shrink-0" data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-20px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start" data-kt-dropdown-trigger="click">
			 ...
			 <div class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
			  <div class="flex items-center justify-between px-2.5 py-1.5 gap-1.5">
			   <div class="flex items-center gap-2">
				...
				<div class="flex flex-col gap-1.5">
				 ...
				 <a class="text-xs text-secondary-foreground hover:text-primary font-medium leading-none" href="{{ url(\'html/demo1/account/home/get-started.html\') }}">
				  c.fisher@gmail.com
				 </a>
				</div>
			   </div>
			  ...
			  <ul class="kt-dropdown-menu-sub">
			   ...
			   <li>
				<a class="kt-dropdown-menu-link" href="{{ url(\'html/demo1/public-profile/profiles/default.html\') }}">
			   ...
			   <li>
				<a class="kt-dropdown-menu-link" href="{{ url(\'html/demo1/account/home/user-profile.html\') }}">
			   ...
			   <li data-kt-dropdown="true" data-kt-dropdown-placement="right-start" data-kt-dropdown-trigger="hover">
				...
				<div class="kt-dropdown-menu w-[220px]" data-kt-dropdown-menu="true">
				 <ul class="kt-dropdown-menu-sub">
				  <li>
				   <a class="kt-dropdown-menu-link" href="{{ url(\'html/demo1/account/home/get-started.html\') }}">
				  ...
				  <li>
				   <a class="kt-dropdown-menu-link" href="{{ url(\'html/demo1/account/security/overview.html\') }}">
				  ...
				  <li>
				   <a class="kt-dropdown-menu-link" href="{{ url(\'html/demo1/account/members/teams.html\') }}">
				  ...
				  <li>
				   <a class="kt-dropdown-menu-link" href="{{ url(\'html/demo1/account/integrations.html\') }}">
			  ...
			  <div class="px-2.5 pt-1.5 mb-2.5 flex flex-col gap-3.5">
			   ...
			   <a class="kt-btn kt-btn-outline justify-center w-full" href="{{ url(\'html/demo1/authentication/classic/sign-in.html\') }}">
				Log out
			   </a>
			  </div>
			 </div>
