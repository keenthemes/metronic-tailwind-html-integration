           ...
           <table class="kt-table table-auto kt-table-border" data-kt-datatable-table="true">
            ...
            <tbody>
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-3.png') }}">
              ...
              <td>
               <div class="flex flex-wrap gap-2">
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/slack.svg') }}">
                 <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/twitch-purple.svg') }}">
                  <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/invision.svg') }}">
                  </img>
                 </img>
                </img>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-23.png') }}">
                 <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                  Jane Smith
                 </a>
                </img>
              ...
              <td>
               <div class="flex flex-wrap gap-2">
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/google-analytics.svg') }}"/>
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/google-calendar.svg') }}"/>
               </div>
              </td>
              <td>
               <div class="flex flex-wrap gap-1.5">
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-1.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Emma Johnson
                </a>
               </div>
              ...
              <td>
               <div class="flex flex-wrap gap-2">
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/tiktok-2.svg') }}"/>
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/monetha.svg') }}"/>
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/twitch-purple.svg') }}"/>
               </div>
              </td>
              <td>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-14.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Michael Brown
                </a>
               </div>
              ...
              <td>
               <div class="flex flex-wrap gap-2">
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/x.svg') }}"/>
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/instagram-2.svg') }}"/>
               </div>
              </td>
              <td>
               <div class="flex flex-wrap gap-1.5">
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-19.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Chloe Davis
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-6.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 William Wilson
                </a>
               </div>
              ...
              <td>
               <div class="flex flex-wrap gap-2">
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/jira.svg') }}"/>
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/slack.svg') }}"/>
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/google-webdev.svg') }}"/>
               </div>
              </td>
              <td>
               <div class="flex flex-wrap gap-1.5">
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-34.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Olivia Martin
                </a>
               </div>
              ...
              <td>
               <div class="flex flex-wrap gap-2">
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/azure.svg') }}"/>
               </div>
              </td>
              <td>
               <div class="flex flex-wrap gap-1.5">
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-4.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Ethan Garcia
                </a>
               </div>
              ...
              <td>
               <div class="flex flex-wrap gap-2">
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/facebook.svg') }}"/>
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/weave.svg') }}"/>
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/plastic-scm.svg') }}"/>
               </div>
              </td>
              <td>
               <div class="flex flex-wrap gap-1.5">
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-13.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Ava Rodriguez
                </a>
               </div>
              ...
              <td>
               <div class="flex flex-wrap gap-2">
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/sololearn.svg') }}"/>
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/twitch-purple.svg') }}"/>
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/linkedin.svg') }}"/>
                <img alt="" class="size-[18px] shrinc-0" src="{{ asset('assets/media/brand-logos/office.svg') }}"/>
               </div>
              </td>
              <td>
               <div class="flex flex-wrap gap-1.5">
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-31.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Matthew Martinez
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-7.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Sophia Anderson
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-8.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Mason Taylor
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-9.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Isabella Lee
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-10.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 James Martinez
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-11.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Emily Thomas
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-12.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Benjamin Harris
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-15.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Charlotte Young
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-16.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Henry Clark
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-17.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Amelia Lewis
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-18.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Lucas Walker
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-20.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Harper White
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-21.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Jack Harris
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-22.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Grace Allen
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-24.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Aiden King
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-25.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Avery Green
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-26.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Ella White
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-27.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Henry King
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-28.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Olivia Green
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-29.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Mason Lewis
                </a>
               </div>
             ...
             <tr>
              ...
              <td>
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-7 shrink-0" src="{{ asset('assets/media/avatars/300-30.png') }}"/>
                <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                 Sophia Lee
                </a>
               </div>
