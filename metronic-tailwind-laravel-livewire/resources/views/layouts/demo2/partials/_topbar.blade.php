 ...
 <div class="flex items-center gap-2.5">
	...
	<div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-20px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start" data-kt-dropdown-trigger="click">
	 <div class="cursor-pointer shrink-0" data-kt-dropdown-toggle="true">
	  <img alt="" class="size-9 rounded-full border-2 border-input shrink-0" src="assets/media/avatars/gray/5.png">
	  </img>
	 </div>
	 <div class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
	   ...
	   <div class="flex items-center gap-2">
		<img alt="" class="size-9 shrink-0 rounded-full border-2 border-green-500" src="assets/media/avatars/300-2.png">
		 <div class="flex flex-col gap-1.5">
		  ...
		  <a class="text-xs text-secondary-foreground hover:text-primary font-medium leading-none" href="html/demo2/account/home/get-started.html">
		   c.fisher@gmail.com
		  </a>
		 </div>
		</img>
	  ...
	  <ul class="kt-dropdown-menu-sub">
	   ...
	   <li>
		<a class="kt-dropdown-menu-link" href="html/demo2/public-profile/profiles/default.html">
	   ...
	   <li>
		<a class="kt-dropdown-menu-link" href="html/demo2/account/home/user-profile.html">
	   ...
	   <li data-kt-dropdown="true" data-kt-dropdown-placement="right-start" data-kt-dropdown-trigger="hover">
		...
		<div class="kt-dropdown-menu w-[220px]" data-kt-dropdown-menu="true">
		 <ul class="kt-dropdown-menu-sub">
		  <li>
		   <a class="kt-dropdown-menu-link" href="html/demo2/account/home/get-started.html">
		  ...
		  <li>
		   <a class="kt-dropdown-menu-link" href="html/demo2/account/security/overview.html">
		  ...
		  <li>
		   <a class="kt-dropdown-menu-link" href="html/demo2/account/members/teams.html">
		  ...
		  <li>
		   <a class="kt-dropdown-menu-link" href="html/demo2/account/integrations.html">
	  ...
	  <div class="px-2.5 pt-1.5 mb-2.5 flex flex-col gap-3.5">
	   ...
	   <a class="kt-btn kt-btn-outline justify-center w-full" href="html/demo2/authentication/classic/sign-in.html">
		Log out
	   </a>
	  </div>
	 </div>
